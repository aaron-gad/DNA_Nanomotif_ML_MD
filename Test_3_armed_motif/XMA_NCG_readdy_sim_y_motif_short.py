...
#run simulation 
#run_sim_1b based on run_sim_1, with option to specify stride for checkpointing         
def run_sim_1b(name,
             folder,
             add_num_1,
    ...
    if new_checkpoint!=None:
        simulation.make_checkpoints(checkpoint_stride, output_directory=new_checkpoint, max_n_saves=max_n_saves)
