...
#evaluate n sims in parallel, get angle distributions and apply fitnes function
#return a fitness score based on link_angle_distr
def eval_sim_1_3_aa_ba_la(folder,names_sim_repeat,t_skip,t_lim,t_step,arm_axis_angle_distr_target,base_angle_distr_target,link_angle_distr_target):
    #names_sim_repeat paths to n sims that are to be evaluated
    ...
    #calculate fitness score
    gt_value=gt_1_3(arm_axis_angle_distr,base_angle_distr,link_angle_distr,    arm_axis_angle_distr_target,base_angle_distr_target,link_angle_distr_target)
    
    return gt_value
    
#evaluate n sims in parallel, get angle distributions and apply fitnes function
#return a fitness score based on link_angle_distr
def eval_sim_1_2_aa_ba(folder,names_sim_repeat,t_skip,t_lim,t_step,arm_axis_angle_distr_target,base_angle_distr_target):
    #names_sim_repeat paths to n sims that are to be evaluated
    ...
    #calculate fitness score
    gt_value=gt_1_2(arm_axis_angle_distr,base_angle_distr,    arm_axis_angle_distr_target,base_angle_distr_target)
